...
public class Player {
	 ...
	 * @param button
	 */
	public void turnOff(Button button, long timeTaken) {
		setMoving(false);
		...
		Log.d("play-stats", "Player: " + this.name);
		Log.d("play-stats", "Turn: " + turns);
		Log.d("play-stats", "Time: " + getMoveTimeAsString(turns));
	}
